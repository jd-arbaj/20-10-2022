...
public class CheckFileExtensionClass {
	...
	public static void main(String[] args) {
		...
		String students[] = {"Arbaj","Boss","DaAn"};
		...
		try {
			...
			System.out.println("Hello "+name +" Your have send a null. Your score is -2");
			System.err.println("NullException :"+ex.getMessage());
		}
		catch(EmptyException ex) {
			System.out.println("Hello "+name +" You have sent a empty. Your score is -3");
